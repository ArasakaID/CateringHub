...
export default function SidebarMenu({ user, show, onClose }) {
    ...
    return (
        <>
            ...
            {/* Sidebar Panel */}
            <div
                className={`fixed top-0 h-full bg-white z-50 shadow-2xl overflow-y-auto transition-transform duration-300 ease-in-out ${
                    show ? 'translate-x-0' : '-translate-x-full'
                }`}
                style={{ width: '375px', maxWidth: '100vw', left: 'max(0px, calc((100vw - 448px) / 2))' }}
            >
                {/* Top Bar */}
